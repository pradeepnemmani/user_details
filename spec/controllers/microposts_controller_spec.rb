...
describe "POST ' create' " do
	...
	describe " success " do
		before(:each) do
			@attr = { :content => "Loren ipsum dolar sit amet"}
		end

		it " should create a micropost" do
 			lambda do
 				post :create, :micropost => @attr
 			end.should change(Micropostm :count).by(1)
		end
		it " should redirect to the root path " do
		  ...
		  it " should have a flash " do
		  	post :create, :micropost => @attr
		  	flash[:success],should =~ /micropost created/1
		  end

	end

	describe "DELETE 'destroy'" do
		describe "for  an unauthenticaed user" do
			before(:each) do
				@user = Factory(:user)
