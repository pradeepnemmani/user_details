  ...
  describe "GET edit " do
     before(:each) do
      ...
      it "should have a link to change the gravatar" do
        get :edit, id => @user
        response.should have_selector('a', :href => 'http://gravatat.com/emails',
                                            :content => "change")
      end
  end
  describe "PUT update" do
    before(:each) do
     ...
     describe "success" do
       ...
       it "should change he user's attributes" do
        put :update, :id => @user, :user => @attr
        user = assigns(:user)
    ...
    describe "GET 'index' " do
      ...
      describe  "for signed-in-users " do
        ...
        it "should have a delete links for admins " do
          @user.toggle!(:admin)
          others_user = User.all.second
          get :index 
          response.should have_selector('a', :href => user_path(others_user),
                                              :content => "delete")
        end
        it "should not have a delete links for non-admins " do
          ...
          others_user = User.all.second
          get :index 
          response.should_not have_selector('a', :href => user_path(others_user),
                                              :content => "delete")
        end
